...
class D96Parser ( Parser ):
    ...
    class Block_des_statementsContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitBlock_des_statements" ):
                return visitor.visitBlock_des_statements(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Des_statements_listContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDes_statements_list" ):
                return visitor.visitDes_statements_list(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Des_statementsContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDes_statements" ):
                return visitor.visitDes_statements(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Des_statementContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDes_statement" ):
                return visitor.visitDes_statement(self)
            else:
                return visitor.visitChildren(self)
